...
console.log("zero: " + BI.bigInt2str(zero,16));
    var one = BI.str2bigInt('1', 16, 0);
console.log("one: " + BI.bigInt2str(one,16));
    var a = BI.str2bigInt(aStr, 16, 0);
console.log("a: " + BI.bigInt2str(a,16));
    var p = BI.str2bigInt(pStr, 16, 0);
console.log("p: " + BI.bigInt2str(p,16));
    var q = BI.sub(p, one);     // q = p-1
console.log("q: " + BI.bigInt2str(q,16));
...
console.log("b: " + BI.bigInt2str(b,16));
    ...
    var temp = BI.sub(BI.add(a,q), b);
console.log("a-b:" + BI.bigInt2str(temp,16));
...
console.log("u: " + uStr + " b: " + BI.bigInt2str(b,16) + " p: " + pStr + " = " + result.r);
        resultB = result.r;
...
console.log("u: " + uStr + " c: " + BI.bigInt2str(c,16) + " p: " + pStr + " = " + result.r);
        resultC = result.r;

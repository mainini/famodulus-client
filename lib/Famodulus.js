...
FamodulusClient.prototype._randomizedList = function (count) {
    // @todo CSPRNG?
...
FamodulusClient.prototype.decsExponent = function () {
    ...
    // @todo checkability
    var serverPermutation = this._randomizedList(2);
    var resultB, resultC;
    this.modexps(modexpsB, serverPermutation[0], function (result) {
        resultB = result;
    ...
    this.modexps(modexpsC, serverPermutation[1], function (result) {
        resultC = result;

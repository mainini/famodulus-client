...
function decExponent (modexps, defaults, options) {
  return new Promise(function (resolve, reject) {
    ...
    var modexpsWithDefaults = modexps.map(modexp => ({b: modexp.b || defaults.b, e: modexp.e || defaults.e, m: modexp.m || defaults.m}));
    ...
    // Server 1
    direct.direct(util.shuffleList(modexpsB, listShuffle), {}, {server: servers[0]}).then(result => {
    ...
    // Server 2
    direct.direct(util.shuffleList(modexpsC, listShuffle), {}, {server: servers[1]}).then(result => {

 ...
 * Required options are 'server' with the full path to the famodulus modexp-API and 'brief',
 * indicating if a brief response is desired.
 * @param {String} base - Base of the modexp
 * @param {String} exponent - Exponent of the modexp
 * @param {String} modulus - Modulus of the modexp
 ...
 * Required options are 'server' with the full path to the famodulus modexp-API and 'brief',
 * indicating if a brief response is desired.
 * @param {Object[]} modexps - An Array with modexps in the form {b:'base', e:'exponent', m:'modulus'} (values may be undefined)
 * @param {Object} defaults - An Object with properties 'base', 'exponent' and 'modulus' to be used as default if omitted in any modexp (values may be undefined)
 * @param {Object} options - Options, requires 'server' and 'brief'
 * @returns {Promise} A promise to the remote modexp calculation.
 */
